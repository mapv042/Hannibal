...
export const metadata: Metadata = {
  title: 'Aviso de privacidad · Hannibal',
  description: 'Aviso de privacidad de Hannibal, el asistente de WhatsApp para consultorios.',
}
...
export default function PrivacyPage() {
  return (
    <LegalLayout title="Aviso de privacidad" updated="3 de agosto de 2026">
      <p>
        Este aviso describe cómo <strong>Hannibal</strong> (&quot;Hannibal&quot;, &quot;nosotros&quot;), operado por{' '}
        <strong>Miguel Ángel Partida Velasco</strong>, con domicilio en{' '}
      ...
      <p>
        Si el consultorio conecta su cuenta de Google, Hannibal accede únicamente a los eventos y disponibilidad
      ...
      <ul>
        ...
        <li>Puedes revocar el acceso en cualquier momento desde la configuración de tu cuenta de Google o desde el panel de Hannibal; al hacerlo, dejamos de sincronizar tu calendario de inmediato.</li>
        <li>El uso que Hannibal hace de la información recibida de las APIs de Google se apega a la <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer">Política de Datos de Usuario de los Servicios de API de Google</a>, incluyendo los requisitos de Uso Limitado.</li>
      </ul>
      ...
      <p>
        ...
        contractualmente a proteger la información y usarla solo para prestar su servicio a Hannibal.
      </p>
